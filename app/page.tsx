...
export default function Page() {
  return (
    <section className="text-black body-font lg:pt-20">
      ...
      <div className="container flex flex-col items-center justify-center p-3 py-8 mx-auto rounded-lg md:p-1">
        <Image src={ring} alt="Ring" priority className="w-auto h-full" />
      </div>
          ...
          <div className="flex flex-col flex-wrap -mb-10 text-center lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left">
            <div className="flex flex-col items-center mb-10 lg:items-start">
              <div className="flex-grow">
                ...
                <p className="mb-2 text-lg leading-relaxed text-neutral-300">
                  ...
                  condizioni di superare i propri limiti, in un ambiente in cui
                  spirito di collaborazione e solidarietà sovrastano
                  l&apos;individualismo.
                </p>
                <Link
                  href="/palestra"
            ...
            <div className="flex flex-col items-center mb-10 lg:items-start">
              <div className="flex-grow">
                ...
                <p className="mb-2 text-lg leading-relaxed text-neutral-300">
                  Oltre al pugilato, ospitiamo diverse discipline, tra cui muay
                  thai, yoga, ginnastica dolce, salsa, power lifting e
                  functional training
                </p>
                <Link
                  href="/palestra"
                ...
                <div className="p-4 lg:w-1/4 md:w-1/2">
                  <div className="flex flex-col items-center h-full text-center">
                    ...
                    <div className="w-full">
                      ...
                      <p className="mb-4 text-neutral-400">
                        Ottimo programmatore, ottimo videomaker, pessimo pugile
                      </p>
                    </div>
                  </div>
                </div>
